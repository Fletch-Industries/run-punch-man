...
const Media = () => {
  ...
  useEffect(() => {
    if (!loading && window.instgrm && window.instgrm.Embeds) {
      setTimeout(() => {
        window.instgrm.Embeds.process();
      }, 100);
    }
  }, [instagramPosts, loading, currentPage]);
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {getCurrentInstagramPosts().map((post, index) => (
                    <div key={post.shortcode} className="flex justify-center">
                      <blockquote 
                        className="instagram-media" 
                        data-instgrm-captioned 
                        data-instgrm-permalink={`https://www.instagram.com/p/${post.shortcode}/?utm_source=ig_embed&utm_campaign=loading`}
                      ...
                      >
                        <div style={{ padding: '16px' }}>
                          <a 
                            href={`https://www.instagram.com/p/${post.shortcode}/?utm_source=ig_embed&utm_campaign=loading`}
                            style={{
                              background: '#FFFFFF',
                              lineHeight: 0,
                              padding: '0 0',
                          ...
                          <p style={{
                            ...
                            <a 
                              ...
                              rel="noopener noreferrer"
                            >
                              A post shared by Run Punch Man (@run_punch_man)
                            </a>
                          </p>
                        </div>
                      </blockquote>
